# Feature Specification: Incident Module — CRUD (Phase A)

**Feature Branch**: `006-incident-crud`
**Created**: 2026-03-31
**Status**: Draft
**Input**: User description: "Módulo de Incidentes — CRUD (Fase A). CRUD puro de incidentes: create, read, update, soft-delete, list com filtros e paginação. Hexagonal architecture, FastAPI backend, SvelteKit frontend, PostgreSQL + pgvector."
